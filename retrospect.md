...
- huamn resources technology team
...
- Users online need to open trainings, watch videos, read documents, sign up for training, access old training content, take quizzes, request extensions. 
- managers need to assign trainings, extend, unlock tests, remove trainings, see user completion status 
- training coordinators - create curriculums, add content, add links, pull training metrics, show completion during audits.
